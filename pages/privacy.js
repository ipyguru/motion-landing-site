    ...
    <div className="relative">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap gap-3 w-full">
          ...
          <p className="mt-4 text-[8px] text-secondary-white">
            ...
            предпринимаемые {contacts.officialName} (далее – Оператор). 1.1.
            ...
            {contacts.domainName}. 2. Основные понятия, используемые в Политике
            ...
            интернет по сетевому адресу {contacts.domainName}. 2.4.
            ...
            определяемому Пользователю веб-сайта {contacts.domainName}. 2.9.
            ...
            посетитель веб-сайта {contacts.domainName}. 2.11. Предоставление
            ...
            электронной почты {contacts.email} с пометкой «Отказ от уведомлений
            о новых продуктах и услугах и специальных предложениях». 7.3.
            ...
            уставные (учредительные) документы Оператора; – федеральные законы,
            ...
            {contacts.domainName} или направленные Оператору посредством
            ...
            согласие с данной Политикой. 8.3. Оператор обрабатывает обезличенные
            данные о Пользователе в случае, если это разрешено в настройках
            браузера Пользователя (включено сохранение файлов «cookie» и
            использование технологии JavaScript). 8.4. Субъект персональных
            ...
            интересе. 9. Условия обработки персональных данных 9.1. Обработка
            персональных данных осуществляется с согласия субъекта персональных
            данных на обработку его персональных данных. 9.2. Обработка
            ...
            оператора функций, полномочий и обязанностей. 9.3. Обработка
            ...
            субъекта персональных данных. 9.6. Осуществляется обработка
            ...
            электронной почты Оператора {contacts.email} с пометкой
            «Актуализация персональных данных». 10.4. Срок обработки
            персональных данных определяется достижением целей, для которых были
            собраны персональные данные, если иной срок не предусмотрен
            договором или действующим законодательством. Пользователь может в
            ...
            согласия на обработку персональных данных». 10.5. Вся информация,
            ...
            почты {contacts.email}. 14.2. В данном документе будут отражены
            ...
            Интернет по адресу {contacts.domainName}/privacy.
          </p>
          <Link
            href="/"
            className={`${styles.btnPrimary} p-4 font-normal text-[16px] text-white`}
          >
            Ок
          </Link>
        </div>
